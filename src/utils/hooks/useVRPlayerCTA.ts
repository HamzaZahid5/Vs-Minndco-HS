...
const callInAppBrowser = async (sessionId: string, assetUrl: string, resourceId: string) => {
  ...
  if (await InAppBrowser.isAvailable()) {
    // AnalyticEvent('video_start', { video_type: 'vr', video_id: resourceId }) not implemented yet
...
const useVRPlayerCTA = ({
  ...
  const openVRPlayer =
    Platform.OS === 'ios' ? openVRPlayerForIOS : Platform.OS === 'android' ? openVRPlayerForAndroid : openVRPlayerForWeb
