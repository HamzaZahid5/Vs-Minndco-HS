import { MindcotineProvider, getMindcotineTheme } from '@mindcoxr/rob'

export const DICTYONARY_PATH = 'dictionaries/v5.0_'
export const PROGRAM_PATH = 'quests_4.16.3_'
export const RobThemeProvider = MindcotineProvider
export const getProductTheme = getMindcotineTheme
...
export const URL_UI_COACHING = 'https://www.mindcotine.com/wp-content/assets/support/index.html'
